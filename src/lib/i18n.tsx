...
const translations: Record<Lang, Dict> = {
  EN: {
    ...
    "whyus.testimonial.text":
      '"Working with Fotojenik has been an unforgettable experience for both our children and parents. Highly recommended."',
    ...
    "contact.map.title": "Fotojenik Batman Studio",
    ...
    "school.orderSent": "Your order has been sent to Fotojenik for review.",
  ...
  TR: {
    ...
    "whyus.testimonial.text":
      '"Fotojenik ile çalışmak hem çocuklarımız hem de velilerimiz için unutulmaz bir deneyim oldu. Kesinlikle tavsiye ediyorum."',
    ...
    "contact.map.title": "Fotojenik Batman Stüdyosu",
    "contact.map.subtitle": "Tilmerç Mh. İbrahim Hakkı Cd.",
    ...
    "school.orderSent": "Siparişiniz Fotojenik'e inceleme için gönderildi.",
    "school.school": "Okul",
  ...
  AR: {
    ...
    "whyus.testimonial.text":
      '"لقد كانت تجربة العمل مع Fotojenik تجربة لا تنسى لأطفالنا وأولياء أمورهم. نوصي بها بشدة."',
    ...
    "contact.map.title": "استوديو Fotojenik باتمان",
    "contact.map.subtitle": "Tilmerç Mh. İbrahim Hakkı Cd.",
    ...
    "school.orderSent": "تم إرسال طلبك إلى Fotojenik للمراجعة.",
...
const STORAGE_KEY = "fotojenik.lang";
